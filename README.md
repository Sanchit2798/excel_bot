...
<img src="assets/example_code_executed.png" alt="Changes are reflected in the spreadsheet" width="500" height="500"/>
...
- You can also chose to edit the code and then execute it. To do this first click on "run code" code button. Then send the updated code in the chat and finally execute it.
	...
	- Changes reflected  
	  <img src="assets/example_updated_code_executed.png" alt="Changes reflected" width="500" height="500"/>
